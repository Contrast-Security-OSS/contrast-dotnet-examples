...
$envVars = @{
    ...
    "COR_PROFILER_PATH_32" = "C:\run\nugetPackage\content\contrastsecurity\ContrastProfiler-32.dll";
    "COR_PROFILER_PATH_64" = "C:\run\nugetPackage\content\contrastsecurity\ContrastProfiler-64.dll";
